...
public enum GameStatus {
    ...
    FINISHED, // represents the state when the user has chosen to start a new game, effectively retiring the old game. The old game is considered finished, and no further actions can be taken on it.
